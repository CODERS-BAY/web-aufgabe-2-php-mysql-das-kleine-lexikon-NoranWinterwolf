...
<body class="pt-5">
    ...
    <div class="container col-md-8 bg-light py-2 my-lg-5">
        <h1 class="container col-md-5 py-2 my-2">
        ...
        <article class="container">
            <img src="img/mainImg.jpg" alt="Howling Wolf" class="mainImg mt-5 custom-border custom-shadow rounded-circle mx-auto d-block">
        </article>
        <hr class="style18 mt-5" />
